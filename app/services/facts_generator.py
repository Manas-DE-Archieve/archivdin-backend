...
Прочитай документ и извлеки 1–3 интересных исторических факта.
Если это просто список имен, выдели общую статистику (например, сколько человек в списке, какой год, какой регион).
...
Если нечего извлечь — верни {{"facts": []}}.
"""
